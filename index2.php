...
<div class="container">
	<header class="header clearfix">
      <div class="logo">Game of Thrones Board game<audio src="http://46.48.164.92:8000/test" controls preload type="audio/mpeg"> </audio><audio src="http://46.48.164.92:8000/test2" controls preload type="audio/mpeg"> </audio><audio src="http://46.48.164.92:8000/test3" controls preload type="audio/mpeg"> </audio></div>
    ...
    <div class="info">
    	<div class="gameinfo clearfix">
            ...
            <!--lands -->
            <!--north -->
            <area shape="poly" coords="113,24,211,24,233,0,137,0" title="CastleBlack" name="1" id="CastleBlack" class="land" style="border:1px solid red; background:#0F0"> 1234234dfgdrg</area>
<div title="Karhold" name="2" id="Karhold" class="land"> </div>
            ...
            <div title="FuntsFinger" name="7" id="FuntsFinger" class="land"> </div>
            ...
            <div name="7" id="FuntsFinger-token" class="token"> </div>
        ...
        <!--<div class="centered">
            <nav id="left_menu">
                <ul>
                    <li><a id="newgame" class="button" href="#">Restart game</a></li>
                    <li><a class="button mainmenu" href="#">Main menu</a></li>
                </ul>
            </nav>
        </div>-->
