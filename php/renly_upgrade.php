...
//upgrade FM to KN
if ($targetunits['unit1'] == 'F1') {
	mysql_query("UPDATE $terr SET `unit1`='K1' WHERE `name` = '$target'");
} else if ($targetunits['unit2'] == 'F1') {
	mysql_query("UPDATE $terr SET `unit2`='K1' WHERE `name` = '$target'");
} else if ($targetunits['unit3'] == 'F1') {
	mysql_query("UPDATE $terr SET `unit3`='K1' WHERE `name` = '$target'");
} else if ($targetunits['unit4'] == 'F1') {
	mysql_query("UPDATE $terr SET `unit4`='K1' WHERE `name` = '$target'");
};
