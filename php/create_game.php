...
mysql_query("UPDATE game SET terr='$terr', house='$house', $myhouse='$user_id' WHERE id=$game_id");

//create new row in battle table
mysql_query("INSERT INTO `battle` (`id`) VALUES ('$game_id');");
...
mysql_query("INSERT INTO gamelist SET game=$game_id, $myhouse='$user_id'");
