...
$targetunit1 = $_GET['targetunit1'];
$targetunit1 = mysql_real_escape_string($targetunit1);
$targetunit2 = $_GET['targetunit2'];
$targetunit2 = mysql_real_escape_string($targetunit2);
$housetable = $_GET['house'];
$housetable = mysql_real_escape_string($housetable);

//update units in target zone
mysql_query("UPDATE $terr SET $targetunit1='0', $targetunit2='0' WHERE name = '$target'");
...
$result = mysql_query("SELECT unit1, garrison, token, control, castle FROM $terr WHERE name = '$target'");
$units = mysql_fetch_assoc($result);
