...
mysql_query("UPDATE `game` SET faza=19 WHERE `id` = $game_id");

//place houses in order of there bids
mysql_query("UPDATE `battle` SET dsup1='$bid1', dsup2='$bid2', dsup3='$bid3', dsup4='$bid4', dsup5='$bid5' WHERE `id` = $game_id");
